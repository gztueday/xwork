...
import com.banggood.xwork.core.common.CacheRelation;
...
public class WorkActionService {
    ...
    private final String[] DEFAULTCLASS = {"com.banggood.xwork.action.impl.DemoAction",
            "com.banggood.xwork.action.core.ConditionWorkAction",
            "com.banggood.xwork.action.core.EndWorkAction",
            "com.banggood.xwork.action.core.StartWorkAction",
            "com.banggood.xwork.action.impl.ShellAction",
            "com.banggood.xwork.action.impl.KettleAction",
            "com.banggood.xwork.action.impl.HiveAction"};
