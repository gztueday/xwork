...
import com.bigdata.xwork.action.function.ParamDescriptor;
import com.bigdata.xwork.core.exception.MatchException;
import com.bigdata.xwork.action.function.TimeFunctionImpl;
...
public class FunctionUtils {
	...
	public static String invokeTimeFunction(FunctionDescriptor fd)
	{
		...
		TimeFunctionImpl tf=new TimeFunctionImpl(System.currentTimeMillis());
